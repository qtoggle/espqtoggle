...
ICACHE_FLASH_ATTR bool                      validate_str_wifi_ssid(char *ssid);
ICACHE_FLASH_ATTR bool                      validate_str_wifi_key(char *key);
ICACHE_FLASH_ATTR bool                      validate_str_wifi_bssid(char *bssid_str, uint8 *bssid);
